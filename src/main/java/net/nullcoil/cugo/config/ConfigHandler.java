...
public class ConfigHandler {
    private static final File configFile = FabricLoader.getInstance().getConfigDir().resolve(CuGO.MOD_ID + "-config.json").toFile();
    ...
    public static void register() {
        ...
        try {
            ...
            CuGO.LOGGER.error("Error loading config", e);
